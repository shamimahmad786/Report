...
isValid: any;
  ...
  //    setTimeout(function () {
      // this.getStateListByYear("2019-20");
  //  }, 2000);
  ...
  getYear(event){
    ...
    this.getSedashboardData("99", this.uniYear)
      ...
      this.getSedashboardData(this.stateCode, this.uniYear)
    }
    // this.getStateList();
    // this.getStateListByYear("2019-20");
...
// this.stateListData=res;
 ...
 getStateListByYear(data){
  // alert(data);
  this._loService.getStateListByYear(data).subscribe(res => {
    // alert(JSON.stringify(res));
    // console.log(JSON.stringify(res))
    this.stateListData=res.rowValue;
    // this.getSedashboardData("99", this.uniYear)
      })
}
